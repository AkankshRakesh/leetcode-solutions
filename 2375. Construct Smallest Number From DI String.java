class Solution {
    ...
    public boolean check(String sequence, String pattern) {
    ...
    public boolean findNextPermutation(char[] numberSequence) {
    ...
    public void swapCharacters(char[] array, int firstIdx, int secondIdx) {
        char temp = array[firstIdx];
        array[firstIdx] = array[secondIdx];
        array[secondIdx] = temp;
    }

    public void reverseSuffix(char[] array, int startIdx, int endIdx) {
